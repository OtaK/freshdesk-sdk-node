...
// @experimental
FreshdeskAPI.prototype.contacts = function() {};
FreshdeskAPI.prototype.contacts.show = function(id, callback) {
    return this.get('/contacts/' + id, callback);
};

FreshdeskAPI.prototype.contacts.makeAgent = function(id, callback) {
    return this.put('/contacts/' + id + '/make_agent', callback);
};

FreshdeskAPI.prototype.contacts.list = function(filters, callback) {
    return this.get('/contacts', filters, callback);
};
